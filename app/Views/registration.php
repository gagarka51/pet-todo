		...
		<div class="container">
			<div class="card w-50 my-5 mx-auto"> 
				<div class="card-body"> 
					...
					<form class="my-5 text-center" method="post" action="../handlers/registration.php">
						<div class="mb-3">
							<label for="exampleInputName" class="form-label">Имя</label>
							<input type="text" class="form-control w-75 d-block mx-auto" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Здесь должно быть ваше имя" name="name">
						</div>

						<div class="mb-3">
							<label for="exampleInputName" class="form-label">Дата рождения</label>
							<input type="date" name="date" class="form-control w-75 d-block mx-auto">
						</div>
						...
						<div class="mb-3">
							...
							<input type="password" class="form-control w-75 d-block mx-auto" id="exampleInputPassword1" placeholder="Повторите ввод пароля" name="confirm">
						</div>
						...
						<button type="submit" class="btn btn-primary mt-4" name="login">Регистрация</button>
						<a class="btn mt-4 btn-registration" href="../index.php">Вход</a>
					</form>
				</div> 
			</div>
		</div>
