...
<body>
	...
	<main>
		<div class="container">
			...
			<div class="row">
				<div class="col-8">
					<form method="post" action="../handlers/confirm_email.php" class="confirm-form" id="confirm-form">
  						<div class="mb-3 mx-auto">
    						<label for="exampleInput" class="form-label">Введите ваш код:</label>
    						<input type="text" class="form-control" id="exampleInput" aria-describedby="help">
    						<div id="help" class="form-text">Нажимая кнопку "Подтвердить", вы соглашаетесь на обработку ваших персональных данных</div>
  						</div>
...
<footer>
	...
	<script type="text/javascript" src="../assets/js/confirm_email.js"></script>
</body>
</html>
<?php } ?>